    ...
    return (
        <div className='mt-4 pt-4 border-t-2 text-2xl'>
            <Tippy content='VSCO' theme='blur' arrow={false}>
                <a href={links.vsco} target='_blank' rel='noreferrer' className='align-middle mx-2'>
                    <svg aria-hidden={true} focusable={false} className='svg-inline--fa' role='img' fill='white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
